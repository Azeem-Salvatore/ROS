...
class Send_marker(object):
    ...
    def pub_marker(self, id, x, y, z=0.03):
    ...
    def run(self):
        time.sleep(10) 
        self.pub_marker(0, 0.1, -0.1)
        time.sleep(10)
        self.pub_marker(1, 0.15, 0)
        time.sleep(10)
        self.pub_marker(2, 0.15, -0.1)
        time.sleep(10)
        self.pub_marker(3, 0.2, -0.1)
        time.sleep(10)
        self.pub_marker(4, 0.15, -0.05)
        time.sleep(10)
